...
# ------------------------------------------------------------
# Duplicate/broken route block removed during repair.
# Final routes continue below.
# ------------------------------------------------------------
...
def chat():
    ...
    try:
        ...
        # -----------------------------
        behavioral_intent = detect_behavioral_intent(canonical_id, player_record)
        ...
        adjust_fragments_from_context(
            ...
            canonical_id,
            player_record,
            violations if violations_flag else []
        )
        ...
        if not is_gibberish(message):
            ...
            history = channel_store.get(channel_key, {}).get("recent_messages", [])
